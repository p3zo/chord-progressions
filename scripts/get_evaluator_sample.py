...
from chord_progressions.chord import (
    serialize_chords,
    get_notes_list_from_midi_num_str,
)
...
if __name__ == "__main__":
    ...
    """
        ...
        chordi.co/ZMbw0YXO
    """
    midi_num_str = "37-53-63_39-55-60-63_44-55-60-63-67_46-58-63-65-67"
    notes_list = get_notes_list_from_midi_num_str(midi_num_str)

    metrics = evaluate_progression(notes_list)
    ...
    """
        ...
        chordi.co/D5q5jb6V
    """
    midi_num_str = "73-75-77_61-63-65_49-51-53_49-53-63_37-53-63_37-49-53-63-65-73-77_37-39-53_53-73-75_37-39-41-49-51-53-61-63-65-73-75-77"
    notes_list = get_notes_list_from_midi_num_str(midi_num_str)
